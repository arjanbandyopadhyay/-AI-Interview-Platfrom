...
function Navbar() {
    ...
    return (    
    <div className="bg-[#fff] flex justify-center px-4 pt-6">
        <motion.div 
        ...
        className="w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray 200 px-8 py-4 flex justify-between items-center relative">
          ...
          <h1 className="font-semibold hidden md:block text-lg">AI Interview Platform</h1>
          </div>
          <div className="flex items-center gap-6 relative" >
            <div className="relative">
              ...
              {showCreditPopup &&(
                <div className="absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray rounded-xl  p-5 z-50">
            ...
            <div className="relative">
              <button onClick={()=>{
                ...
                {userData ?userData?.name.slice(0,1).toUpperCase():<FaUserAstronaut siz={16}/>} 
              </button>
              {showUserPopup &&(
